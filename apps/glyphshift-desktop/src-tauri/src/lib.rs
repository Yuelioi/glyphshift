...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            probe::commands::desktop_probe_runs,
            probe::commands::desktop_compatible_probe_adapters,
            probe::commands::desktop_delete_probe_runs,
            probe::commands::desktop_update_probe_run,
            probe::commands::desktop_clear_probe_run_entries,
            ...
            probe::commands::desktop_sync_probe_dictionary_entries,
            probe::commands::desktop_bulk_probe_entries,
            probe::commands::desktop_export_probe_run,
