...
export const model = {
  ...
  adapters: [{
    ...
    id: 'windows.unity.il2cpp.standard-ui', name: 'Unity IL2CPP 标准界面', summary: '翻译 Windows x64 Unity IL2CPP 应用中的 TMP/uGUI 标准 text 属性；不适用于 UI Toolkit、NGUI、自绘文字或 TMP SetText 快捷入口',
    version: '0.1.0', platforms: ['windows'], technologies: ['Unity IL2CPP / TextMeshPro / uGUI'], features: ['textObserve', 'textReplace'], technicalTarget: 'IL2CPP runtime!TMP_Text.set_text + UnityEngine.UI.Text.set_text', documentationUrl: 'https://docs.unity3d.com/6000.0/Documentation/Manual/scripting-backends-il2cpp.html', configuration: 'none',
  }],
  workflows: [{
