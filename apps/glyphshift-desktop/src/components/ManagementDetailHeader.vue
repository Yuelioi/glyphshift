...
<template>
  <header
    ...
    class="-mx-4 -mt-4 flex min-h-16 shrink-0 border-b border-[var(--border)] bg-[var(--titlebar)] px-4"
    :class="props.flushAfter ? 'mb-0' : 'mb-4'"
  >
    <div
    ...
    >
      <div
        ...
        class="flex min-h-16 w-full items-center justify-between gap-4"
      >
