...
const fieldUi = computed(() => ({
  root: props.multiline
    ...
    : props.description
      ...
      : '!grid min-h-14 grid-cols-[184px_minmax(0,1fr)] items-center gap-8 border-b border-[var(--border)] py-2.5 last:border-b-0 @max-[620px]:grid-cols-1 @max-[620px]:items-start @max-[620px]:gap-2',
