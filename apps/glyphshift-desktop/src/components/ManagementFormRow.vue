...
const fieldUi = computed(() => ({
  ...
  label: 'flex items-center gap-2.5 text-[11px] font-semibold text-[var(--text-secondary)]',
  description: props.icon
    ? 'mt-1 pl-7 text-[10px] leading-4 text-[var(--text-muted)]'
    : 'mt-1 text-[10px] leading-4 text-[var(--text-muted)]',
